...
if ("TURBOPACK compile-time falsy", 0) {
    ...
    if (!global._pgPool) {
        global._pgPool = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pg$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Pool"]({
...
"[project]/src/lib/data:085ef1 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$085ef1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:085ef1 [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Home({ params, searchParams }) {
    ...
    const handleLogin = async (email, password_unused)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM agents WHERE email = $1', [
                email.toLowerCase()
            ]);
            const agent = result.rows[0];
            if (agent && agent.password) {
                const isPasswordValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$085ef1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["verifyPassword"])(password_unused, agent.password);
                if (isPasswordValid) {
                    setCurrentUser({
                        name: agent.name,
                        avatar: agent.avatar,
...
//# sourceMappingURL=src_ad900385._.js.map